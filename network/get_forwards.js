        ...
        forwards: [
           ...
           cbk) =>
          {
            const peers = nodes.map(node => {
              ...
              const isDisconnected = connected.length === 0 && pending.length === 0;
              ...
              return {
                ...
                is_inactive: !isDisconnected && active.length === 0 || undefined,
                is_pending: pending.length > 0 || undefined,
                is_private: !!isHidden || undefined,
                last_inbound_at: lastIn ? lastIn.toISOString() : undefined,
                last_outbound_at: lastOut ? lastOut.toISOString() : undefined,
