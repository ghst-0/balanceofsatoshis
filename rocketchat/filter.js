...
function preprocess(filter) {
  ...
  const expanded = [filter]
    ...
    .flatMap((q) => {
      ...
      return expanded.filter(([s]) => { let _a; return !!((_a = valid[s]) === null || _a === void 0 ? void 0 : _a[l2]); });
    })
    // expand L2
    .flatMap((q) => {
      const [l1, l2, l3] = q;
      ...
      return expanded.filter(([, s]) => { let _a, _b; return !!((_b = (_a = valid[l1]) === null || _a === void 0 ? void 0 : _a[s]) === null || _b === void 0 ? void 0 : _b[l3]); });
    });
...
export { matchFilter, parse, preprocess };
