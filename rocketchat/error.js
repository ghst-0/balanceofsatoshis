...
function toGrammyError(err, method, payload) {
  switch (err.error_code) {
    case 401:
      console.error("Error 401 means that your bot token is wrong, talk to https://t.me/BotFather to check it.");
      break;
    case 409:
      console.error("Error 409 means that you are running your bot several times on long polling. Consider revoking the bot token if you believe that no other instance is running.");
      break;
  }
...
export { HttpError, toGrammyError, toHttpError, GrammyError }
